...
class PlayState extends MusicBeatState
{
	...
	{
		ScriptRegistry.registerCharacters();
		...
		var testChar = new scripting.ScriptedCharacter(SONG.player2);
		add(testChar);
	...
	// Odds are that the character scripts will be made into scriptable classes
	...
	// This system would probably be used ONLY on uhhh, idk tbh,
	// Notes can be scriptable, characters, the song itself
	#if HSCRIPT_ALLOWED
